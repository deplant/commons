...
public sealed interface Result<T> permits Ok, Err {
	...
	/**
	 * Transforms Err original exception with a provided function to a new exception, If result was Ok,
	 * no transformations will be done.
	 *
	 * @param exceptionFunction function to transform exception
	 * @return Result with transformed exception
	 */
	Result<T> mapErr(Function<Exception,Exception> exceptionFunction);

	/**
	 * Transforms Err original exception with a provided function to a string for logging,
	 * then logs it to System.Logger as Level.ERROR.
	 *
	 * @param exceptionLogFunction function to process exception
	 * @return Same Result object after logging error, no transformation done
	 */
	Result<T> logErrError(Function<Exception,String> exceptionLogFunction);
	 ...
	 * @return Same Result object after logging error, no transformation done
	 */
	Result<T> logErrWarn(Function<Exception,String> exceptionLogFunction);
	 ...
	 * @return Same Result object after logging error, no transformation done
	 */
	Result<T> logErrInfo(Function<Exception,String> exceptionLogFunction);
	 ...
	 * @return Same Result object after logging error, no transformation done
	 */
	Result<T> logErrDebug(Function<Exception,String> exceptionLogFunction);
	 ...
	 * @return Same Result object after logging error, no transformation done
	 */
	Result<T> logErrTrace(Function<Exception,String> exceptionLogFunction);
