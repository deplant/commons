...
public class ResultTest {
	...
	Function<Exception,Exception> function_text_ex = e -> new TestException(TEST_EX_MSG);
	...
	@Test
	void mapErr_lazy() {
		assertThrows(TestException.class, () -> NULL_RESULT.mapErr(function_text_ex).orElseThrow());
		assertThrows(TestException.class, () -> ERR_RESULT.mapErr(function_text_ex).orElseThrow());
		assertEquals(8, OK_RESULT.mapErr(function_text_ex).orElse(() -> 0));
	}
